<template>
  <nav
    class="bg-white px-2 sm:px-4 py-2.5 mb-10 w-full z-20 top-0 left-0 border-b border-gray-200"
  >
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="flex md:order-2">
        <span class="self-center mr-4 text-xl font-semibold whitespace-nowrap">
          🛒</span
        >
        <button
          type="button"
      ...
      >
        ...
        >
          ...
          <li>
            <a
              href="#"
              class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-700 md:p-0"
              >Categories</a
            >
          </li>
          <li>
